      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <form role="form" action="/obat-penjualan" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
...
<script src="assets/AdminLTE/dist/js/demo.js"></script><script src="assets/AdminLTE/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>

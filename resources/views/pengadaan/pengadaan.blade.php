...
<div class="modal fade" id="modal-profil" role="dialog">
    ...
    @php if(Session::get('kadaluarsa')){ @endphp 
                <div class="alert alert-danger" >
                    <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span></button>
                     Obat yang anda pilih adalah obat kadaluarsa, harap kosongkan stok dahulu sebelum menambah pengadaan obat!!
    </div> @php } @endphp
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Riwayat Pengadaan</h3><br>
            ...
            <form role="form" action="/pengadaan-pengadaan" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="col-md-1 pr-1">
                      <div class="form-group">
                        <label style="color:white;">,l</label>
                         <br><a class="btn btn-primary" href="/cetak-pengadaan-pengadaan"><i class="fa fa-print"></i></a>
                      </div>
              </div>              

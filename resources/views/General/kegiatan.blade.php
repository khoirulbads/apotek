...
<div class="modal fade" id="modal-edit{{$datas->id_kegiatan}}" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="/admineditkegiatan" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
                <div class="card-body">
                  <input class="form-control" type="hidden" name="id" id="id" value="{{ $datas->id_kegiatan}}">
                   <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label>Nama Kegiatan</label>
                        <input type="text" class="form-control"  placeholder="judul" name="nama_kegiatan" required="true" value="{{$datas->nama_kegiatan}}">
                      </div>
                    </div>
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label>Waktu/Tempat</label>
                        <input type="text" class="form-control"  placeholder="judul" name="waktu" required="true" value="{{$datas->waktu}}">
                      </div>
                    </div>
                  </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$datas->waktu}}</td>
                  <td> <h4 data-toggle="modal" data-target="#modal-edit{{$datas->id_kegiatan}}" class="btn btn-primary">Edit</h4></td></tr>
                @endforeach
                </tbody>

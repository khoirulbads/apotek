        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="/admintambahgaleri" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
                <div class="card-body">
                   <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Galeri</h3><br>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{$datas->id_galeri}}</td>
                  <td> <img src="images/galeri/{{$datas->foto_galeri}}"  height="30px" width="30px" alt="image">
                  </td>
                  <td>{{$datas->judul_galeri}}</td>
                  <td><a href="/adminhapusgaleri/{{$datas->id_galeri}}"class="btn btn-danger btn-xs" onclick="return(confirm('Apakah Data ini Akan dihapus?'));">Hapus
                        </a> </td></tr>
                @endforeach
                </tbody>

        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="/admintambahberita" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
                <div class="card-body">
                   <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label>Judul</label>
                        <input type="text" class="form-control"  placeholder="judul" name="judul" required="true">
                      </div>
                    </div>
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label>Isi</label>
                        <textarea class="form-control" id="editor1" name="isi" rows="10" cols="80">
...
<div class="modal fade" id="modal-edit{{$datas->id_berita}}" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
              <form role="form" action="/admineditberita" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
                <div class="card-body">
                  <input class="form-control" type="hidden" name="id" id="id" value="{{ $datas->id_berita}}">
                   <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label>Nama Kegiatan</label>
                        <input type="text" class="form-control"  placeholder="judul" name="judul" required="true" value="{{$datas->judul_berita}}">
                      </div>
                    </div>
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label>Waktu/Tempat</label>
                        <textarea type="text" class="form-control"   required="true" id="editor1" name="isi" rows="10" cols="80">{{$datas->isi_berita}}</textarea> 
                      </div>
                    </div>
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
      ...
      @endforeach
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Berita</h3><br>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td> <img src="images/berita/{{$datas->foto_berita}}"  height="30px" width="30px" alt="image">
                  </td>
                  <td>{{$datas->judul_berita}}</td>
                  <td>{{$datas->tanggal_berita}}</td>
                  <td>
                    <a href="/adminhapusberita/{{$datas->id_berita}}"class="btn btn-danger" onclick="return(confirm('Apakah Data ini Akan dihapus?'));">Hapus
                        </a> <a data-toggle="modal" data-target="#modal-edit{{$datas->id_berita}}" class="btn btn-warning">Edit</a></td></tr>
                @endforeach
                </tbody>
